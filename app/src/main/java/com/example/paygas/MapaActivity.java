...
import com.example.paygas.ui.Mapa;
...
// Add the symbol layer icon to map for future use
                style.addImage(symbolIconId, BitmapFactory.decodeResource(MapaActivity.this.getResources(), R.drawable.blue_marker_view));
...
// Set up a new symbol layer for displaying the searched location's feature coordinates
    ...
    private void addDestinationIconSymbolLayer(@NonNull Style loadedMapStyle) {
        loadedMapStyle.addImage("destination-icon-id", BitmapFactory.decodeResource(this.getResources(), R.drawable.blue_marker_view));
